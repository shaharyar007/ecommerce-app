...
const ProductDetail = () => {
  ...
  const addToCart = (e) => {
      const btnId = e.target.dataset.item;
      console.log(btnId);
      if(btnId == id){
                    ...
                    <div ClassName="col-md-6">
                        <div ClassName="product p-4">
                            ...
                            <div ClassName="mt-4 mb-3"> <span ClassName="text-uppercase text-muted brand">Orianz</span>
                                <h5 ClassName="text-uppercase">{item.name}{item.id}</h5>
                            ...
                            <div ClassNameName="cart mt-4 align-items-center">
                         <button ClassName="btn btn-danger text-uppercase mr-2 px-4" data-item={item.id}  onClick={addToCart}>Add to cart</button> <i ClassName="fa fa-heart text-muted"></i> <i ClassName="fa fa-share-alt text-muted"></i> </div>
                        </div>
                    </div>
                </div> 
                   ))}
